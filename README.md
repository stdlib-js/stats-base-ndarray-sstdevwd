...
> Calculate the [standard deviation][standard-deviation] of a one-dimensional single-precision floating-point ndarray using Welford's algorithm.
...
```javascript
sstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-sstdevwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/tags). For example,

```javascript
sstdevwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-sstdevwd@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sstdevwd = require( 'path/to/vendor/umd/stats-base-ndarray-sstdevwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-sstdevwd@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-ndarray-sstdevwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-ndarray-sstdevwd

[test-image]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-ndarray-sstdevwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-ndarray-sstdevwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-ndarray-sstdevwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-ndarray-sstdevwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-ndarray-sstdevwd/blob/main/branches.md
